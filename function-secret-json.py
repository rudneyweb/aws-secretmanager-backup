...
def backup_secrets(output_dir):
    ...
    for secret in secrets:
        ...
        # Save the secret to a JSON file with the secret name as the filename
        backup_file_path = os.path.join(output_dir, f"{secret_name.replace('/', '_')}.json")
...
if __name__ == "__main__":
    ...
    backup_directory = "backup_secrets_output"
